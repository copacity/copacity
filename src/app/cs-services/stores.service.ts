...
import { Category, StoreCoupon, PQRSF, ShippingMethod, PlatformFee, Vendor, ErrorMessage } from '../app-intefaces';
...
export class StoresService {
  ...
  public create(store: Category): Promise<DocumentReference> {
    return this.angularFirestore.collection(this.collectionName).add(store);
  }

  public createPlatformFess(platformFee: PlatformFee): Promise<DocumentReference> {
    return this.angularFirestore.collection('platformFees').add(platformFee);
  }

  public getPlatformFess() {
    this.storesCollection;

    this.storesCollection = this.angularFirestore.collection<PlatformFee>('platformFees');
  ...
  public getAllSearch(searchText: string): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
      let storesCollection = this.angularFirestore.collection<Category>(this.collectionName, ref => ref
        .where('deleted', '==', false)
        .where('status', '==', StoreStatus.Published));
  ...
  public _getAll(): Observable<Category[]> {
    this.storesCollection = this.angularFirestore.collection<Category>(this.collectionName, ref => ref
      .where('deleted', '==', false)
      .where('status', '==', StoreStatus.Published));
  ...
  // --------------------- STORE COUPONS
  public createStoreCoupon(storeCoupon: StoreCoupon): Promise<DocumentReference> {
  ...
  public getStoreCouponsXStore(): Observable<StoreCoupon[]> {
    let storesCollection = this.angularFirestore.collection("coupons", ref => ref
      .where('deleted', '==', false));
  ...
  public getStorePQRSF(): Observable<PQRSF[]> {
  ...
  public getStorePQRSFByUser(idUser: string): Observable<PQRSF[]> {
    let storesCollection = this.angularFirestore
      .collection("pqrsf", ref => ref
        .where('deleted', '==', false)
        .where('idUser', '==', idUser)
  ...
  //------------------------------- Vendors
  public createVendor(vendor: Vendor): Promise<DocumentReference> {
    return this.angularFirestore
      .collection("vendors").add(vendor);
  }

  public updateVendor(idVendor: string, data: any) {
    return this.angularFirestore
  ...
  public getVendorsByIdUser(idUser: string): Observable<Vendor[]> {
    let storesCollection = this.angularFirestore
      .collection("vendors", ref => ref
        .where('deleted', '==', false)
        .where('idUser', '==', idUser));
