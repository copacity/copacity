...
$(document).ready(function(){      
    ...
    setTimeout(function(){
        $('.pwa-dismiss').on('click',function(){
            ...
            createCookie('Eazy_pwa_rejected_install', true, 1);
    ...
    function updateModal(){
        ...
        if(!updateModal.length){
           body.append('<div id="menu-update" class="bg-theme"></div>');
           setTimeout(function(){
    ...
    //Check Version and Enable Update if Necessary. Essential on iOS
            ...
            function versionCheck(){        
                ...
                setTimeout(function(){
                    ...
                    if(onlineVersionNumber != localVersionNumber && onlineVersionNumber != "Connection Offline. Waiting to Reconect"){
                        updateModal();
                        $('#menu-install-pwa-android, #menu-install-pwa-ios').removeClass('menu-active');
                        setTimeout(function(){
